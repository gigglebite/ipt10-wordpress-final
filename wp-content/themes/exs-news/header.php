...
$skip_link_id = is_singular( 'post' ) ? 'title' : 'main';

?>
<a id="skip_link" class="screen-reader-text skip-link" href="#<?php echo esc_attr( $skip_link_id ); ?>"><?php echo esc_html__( 'Skip to content', 'exs' ); ?></a>
<?php
