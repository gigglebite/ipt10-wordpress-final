<?php 
  $banner_image             = newseqo_option('newseqo_page_banner_img');
  $banner_title             = newseqo_option('newseqo_page_banner_title','')!=''?newseqo_option('newseqo_page_banner_title'):get_the_title();
  $show                     = newseqo_option('newseqo_page_banner_enable');
  $show_breadcrumb          = newseqo_option('newseqo_page_banner_breadcrumb_enable');
...
<?php if($show === '__true'): ?>
            <div class="container" <?php echo wp_kses_post( $banner_img_url ); ?>>
               <div class="col-md-12 text-center banner-area <?php echo esc_attr($banner_img_url == ''?'banner-solid':'banner-bg'); ?>">
